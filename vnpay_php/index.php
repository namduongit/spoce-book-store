                ...
                <form action="vnpay_create_payment.php" id="create_form" method="post">       
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="txt_billing_fullname"
                               name="txt_billing_fullname" type="text" value="Nguyễn Nam Dương"/>             
                    </div>
                    <div class="form-group">
                        <label >Email (*)</label>
                        <input class="form-control" id="txt_billing_email"
                               name="txt_billing_email" type="text" value="nguyennamduong205@gmail.com"/>   
                    </div>
                    <div class="form-group">
                        <label >Số điện thoại (*)</label>
                        <input class="form-control" id="txt_billing_mobile"
                               name="txt_billing_mobile" type="text" value="0388853835"/>   
                    </div>
                    <div class="form-group">
                        <label >Địa chỉ (*)</label>
