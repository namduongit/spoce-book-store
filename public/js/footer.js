...
function showFooterInfo(info) {
    ...
    if (info === 'aboutus') {
        ...
        <p>Trong trường hợp quý khách đã thanh toán, ngân hàng đã thông báo trừ tiền vào thẻ hoặc ghi nợ vào thẻ, nhưng Spoce vẫn thông báo giao dịch không thành công, vui lòng liên hệ với tổng đài Vinabook 0388.853.835 hoặc email spoce_bookstore@gmail.com để được hỗ trợ.</p>
